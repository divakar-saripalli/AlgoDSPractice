...
public class UnderscorifySubstring {
    ...
    private static String underscorifySubstring(String str, String substring) {
        ...
        String possibleOverlap = UnderscorifySubstring.findPossibleOverlapSubstring(substring);
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if (str.charAt(i) == substring.charAt(substringIndex)) {
                ...
                if (noOfMultipleSubseuences > 0) {
                    ...
                    String finalString = str.substring(endIndex);
...
//		DivakarMahiMahiAksharaMahi
        System.out.println(UnderscorifySubstring.underscorifySubstring("testthis is a testtest to see if testestest it works", "test"));
    }
}
