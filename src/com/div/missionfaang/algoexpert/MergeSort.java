...
public class MergeSort {
    ...
    private static int[] mergeSort(int[] array) {
        if (array.length < 3) {
            ...
            int[] array1 = MergeSort.mergeSort(leftArray);
            int[] array2 = MergeSort.mergeSort(rightArray);
    ...
    private static List<Integer> mergeSort(List<Integer> array) {
        if (array.size() < 3) {
            ...
            List<Integer> array1 = MergeSort.mergeSort(leftArray);
            List<Integer> array2 = MergeSort.mergeSort(rightArray);
