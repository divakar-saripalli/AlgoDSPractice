...
class Result {
    ...
    static List<Integer> componentsInGraph(List<List<Integer>> gb) {
        ...
        int currentEdges = 0;
        int currentIndex = Result.getNodeIndexToProcess(gb);
        ...
        while (currentIndex != -1) {
            ...
            currentIndex = Result.getNodeIndexToProcess(gb);
            currentEdges = 0;
        }
        result.set(0, min);
        result.set(1, max);
    ...
    private static int getNodeIndexToProcess(List<List<Integer>> list) {
