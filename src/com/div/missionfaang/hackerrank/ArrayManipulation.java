...
public class ArrayManipulation {
    ...
    private static long arrayManipulation(int size, int[][] queries) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String[] nm = ArrayManipulation.scanner.nextLine().split(" ");
        ...
        for (int i = 0; i < m; i++) {
            String[] queriesRowItems = ArrayManipulation.scanner.nextLine().split(" ");
            ArrayManipulation.scanner.skip("(\r\n|[\n\r\u2028\u2029\u0085])?");
        ...
        ArrayManipulation.scanner.close();
    }
}
