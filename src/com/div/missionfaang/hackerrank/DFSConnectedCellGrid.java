...
public class DFSConnectedCellGrid {
    public static void main(String[] args) {
        ...
        System.out.println(DFSConnectedCellGrid.getMaxRegionCount(grid));
    }

    private static int getMaxRegionCount(int[][] array) {
        ...
        for (int i = 0; i < array.length; i++) {
            for (int j = 0; j < array[i].length; j++) {
                if (array[i][j] == 1) {
                    ...
                    mcd = DFSConnectedCellGrid.findRegionCount(array, markCell, i, j, mcd);
        ...
        if (!markCell[rowIndex][columnIndex]) {
            ...
            if (rowIndex > 0 && columnIndex > 0) {
                if (array[rowIndex - 1][columnIndex - 1] == 1) {
                    mcd = DFSConnectedCellGrid.findRegionCount(array, markCell, rowIndex - 1, columnIndex - 1, mcd);
                }
            }
            if (columnIndex > 0) {
                if (array[rowIndex][columnIndex - 1] == 1) {
                    mcd = DFSConnectedCellGrid.findRegionCount(array, markCell, rowIndex, columnIndex - 1, mcd);
                }
            }
            ...
            if (rowIndex > 0) {
                if (array[rowIndex - 1][columnIndex] == 1) {
                    mcd = DFSConnectedCellGrid.findRegionCount(array, markCell, rowIndex - 1, columnIndex, mcd);
                }
            }
...
class MarkCellData {
     ...
     * @param markedCell
     */
    void setMarkedCell(boolean[][] markedCell) {
