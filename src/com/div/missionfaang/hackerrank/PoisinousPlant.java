...
public class PoisinousPlant {
    ...
    public static void main(String[] args) throws IOException {
        int n = PoisinousPlant.scanner.nextInt();
        PoisinousPlant.scanner.skip("(\r\n|[\n\r\u2028\u2029\u0085])?");

        int[] p = new int[n];

        String[] pItems = PoisinousPlant.scanner.nextLine().split(" ");
        PoisinousPlant.scanner.skip("(\r\n|[\n\r\u2028\u2029\u0085])?");
        ...
        System.out.println(PoisinousPlant.poisonousPlants(p));

        PoisinousPlant.scanner.close();
    }
}
